...
Fala galera, uma atividade que precisa de bastante atenção na vida do DBA é a restauração do backup em uma instância no mesmo servidor (ambiente produtivo). Um dos maiores receio dos **DBA's** é sobrescrever algum arquivo do ambiente produtivo ou ambiente de origem do backup.  <br>
